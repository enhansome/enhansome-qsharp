...
* [Q# samples](https://github.com/Microsoft/Quantum) ⚠️ Archived
* [Q# libraries](https://github.com/Microsoft/QuantumLibraries) ⚠️ Archived
* [Q# libraries for the Quantum Development Kit](https://github.com/microsoft/QuantumLibraries) ⚠️ Archived
* [Quantum Computing Libraries for noncommercial use](https://github.com/Microsoft/Quantum-NC) ⚠️ Archived
...
* [Quantum Perceptron](https://github.com/Microsoft/MLADS2018-QuantumML) ⚠️ Archived - Materials for self-paced "Introduction to Quantum Machine Learning" workshop presented at MLADS 2018.
* [Deutsch-Jozsa Algorithm](https://github.com/Microsoft/GHC18-IntroToQuantumComputing/) ⚠️ Archived - Materials for self-paced "Introduction to Quantum Computing" workshop presented at Grace Hopper Celebration 2018 and Hopper x1 Seattle 2019.
* [Quantum Classification](https://github.com/microsoft/MLADS2020-QuantumClassification) ⚠️ Archived - Materials for self-paced "Introduction to Quantum Classification" lab presented at MLADS 2020.
...
* [Solutions to the 2018 Microsoft Q# Coding Challenge and Warm-Up on Codeforces](https://github.com/RobertDurfee/QSharpCodingChallenge) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2018-10-06
* [Q# codes by Hiroshi Kurokawa](https://github.com/hkurokawa/QSharpCodingContest2018) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2018-07-16
* [No Description\_ by Hajime Fukuda](https://github.com/hajifkd/qsharp-vscode) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2018-07-10

## IDE Integration

<!--lint ignore double-link-->

* [Emacs](https://github.com/forked-from-1kasper/emacs-qsharp-mode) ⭐ 4 | 🐛 1 | 🌐 Emacs Lisp | 📅 2023-05-02
* [Vim](https://github.com/gootorov/q-sharp.vim) ⭐ 3 | 🐛 0 | 🌐 Vim script | 📅 2019-03-21
...
* [QuantumPeep](https://github.com/mapmeld/quantum-peep) ⭐ 34 | 🐛 11 | 🌐 TypeScript | 📅 2023-01-03 - Generate Q# from JavaScript/TypeScript.
* [A implementation of Shor's algorithm written in Python calling Q# for the quantum part](https://github.com/Michaelvll/myQShor) ⭐ 29 | 🐛 0 | 🌐 HTML | 📅 2019-07-28
* [Hadamard Gate Q# Demo](https://github.com/jwulf/HGate) ⭐ 7 | 🐛 0 | 🌐 Q# | 📅 2021-03-18
* [Q# Bell State Program](https://github.com/pktippa/q_sharp_bell_state) ⭐ 2 | 🐛 0 | 🌐 C# | 📅 2017-12-22
* [Quantum Computing Q# Introduction 2018](https://github.com/Djohnnie/QuantumComputingQSharpIntroduction2018) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2019-02-08
* [Q# playgroud](https://github.com/weize07/Qsharp-playgroud) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2018-06-21
